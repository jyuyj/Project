...
<%@page import="com.maumgagym.search.dto.SearchTO"%>
<%@page import="com.maumgagym.search.dao.SearchDAO"%>
...
<%
	...
	ArrayList<SearchTO> searchLists = (ArrayList<SearchTO>)request.getAttribute( "list" );
	//System.out.println( "searchLists.size() : " + searchLists.size() );

	StringBuilder sb = new StringBuilder();
	
	for( SearchTO sto : searchLists ){
